...
<head>
    ...
    <title>Thêm Danh Mục | PHỤ KIỆN XE MÁY</title>
...
<div class="main-content">
    <div class="topbar">
        <div>
            <div class="topbar-title">Thêm Danh Mục Mới</div>
            <div class="topbar-breadcrumb">Trang chủ &rsaquo; Danh mục &rsaquo; Thêm mới</div>
        </div>
            ...
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name"
                        ...
                        placeholder="Ví dụ: Phuộc & Giảm xóc Ohlins"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" rows="4"
                        ...
                        placeholder="Nhập mô tả các dòng phụ kiện...">{{ old('description') }}</textarea>
                    @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="d-flex gap-2 justify-content-end border-top pt-3">
                    <a href="{{ route('categories.index') }}" class="btn-cancel"><i class="fa-solid fa-xmark"></i> Hủy</a>
                    <button type="submit" class="btn-save"><i class="fa-solid fa-floppy-disk"></i> Lưu danh mục</button>
                </div>
            </form>
        </div>
    </div>
